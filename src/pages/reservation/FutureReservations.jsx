...
const FutureReservations = ({ futureReservations }) => {
  const [reservationStatus, setReservationStatus] = useState(
    futureReservations.map(() => true), // Initialize with '예약 가능' for each reservation
  )
            ...
            <CardContent>
              {futureReservations.length === 0 ? (
                <Typography variant="body1">
                  예정된 예약이 없습니다. <SentimentDissatisfiedIcon />
                </Typography>
              ) : (
                <Table>
                  <TableHead>
